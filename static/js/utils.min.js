...
var Hutils = {
    ...
    initMenu:function(TypeId,Id,Group1,Group2,Group3){
        ...
        var __genDiv = function (element) {
            ...
            var open_type = element.resOpenType;
            var newIframe = element.newIFrame;
            var innerFlag = element.flag;
    ...
    $.fn.initTraditionMenu = function(param){
        ...
        function genTreeUI(a){
            ...
            for(var i = 0; i < a.length; i++) {
                ...
                li.setAttribute("data-id",a[i].dept);
                ...
                if (a[i].Res_attr == "1") {
                    // 叶子
                    li.className = "HMenuLiLeaf mdl-js-ripple-effect mdl-js-button mdl-button--raised mdl-text--white";
                    ...
                    // 结点
                    li.className = "HTreeshowOrHideIconHzw mdl-js-ripple-effect mdl-js-button mdl-button--raised mdl-color--grey-100";
                    li.style.borderTop = "#c7c7c7 solid 1px";

...
var Hutils = {
    ...
    initMenu:function(typeId,id,group1,group2,group3){
        ...
        var __genDiv = function (resId,resClass,resBgColor,resImg,resName,resUrl,openType) {
            var mdiv = document.createElement("div")
            $(mdiv).attr({
                "data-id":resId,
                "data-role":"tile",
            ...
            }).addClass(resClass).addClass("fg-white mfdiv")
                .css("background-color",resBgColor);
            ...
            $(mimg).attr("src",resImg)

            var ccdiv = document.createElement("div");
            $(ccdiv).addClass("tile-label").html(resName);
        ...
        $.HAjaxRequest({
            ...
            success: function(data){
                ...
                $(data).each(function(index,element){
                    var gid = parseInt(element.groupId)-1;
                    var mdiv = divlist[gid];
                    $(mdiv).append(__genDiv(element.resId,element.resClass,element.resBgColor,element.resImg,element.resNme,element.resUrl,element.resId,element.resClass,element.resBgColor,element.resImg,element.resName,element.resUrl,element.openTypeId));
                });
